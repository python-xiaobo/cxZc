...
var ec_world_option = {
    dataset: {source: []},
    toolbox: {show: false, feature: {saveAsImage: {show: true, type: "jpeg"}}},
    title: {
        text: "海外疫情图析",
        subtext: "\n实时数据更新\n",
        x: "60%",
        y: "150",
        textStyle: {fontSize: 27, fontWeight: "bold", fontFamily: "Microsoft YaHei", color: "#000"},
        subtextStyle: {fontStyle: "italic", fontSize: 14}
    },
    legend: {
        x: "55%",
        y: "350",
        ...
        formatter: function (params) {
            for (var i = 0; i < legenddata.length; i++) {
                if (legenddata[i].name == params) {
                    return params + "\t确诊:" + legenddata[i].Confirmed;
                }
            }
        }
    },
    ...
    series: [{
        ...
        center: ["40%", "60%"],
        roseType: "area",
        encode: {itemName: "Country", value: "SQRT"},
        itemStyle: {
            normal: {
                ...
                label: {
                    position: "inside",
                    textStyle: {fontWeight: "bold", fontFamily: "Microsoft YaHei", color: "#FFFFFF", fontSize: 9},
                    formatter: function (params) {
        ...
        radius: [10, 27],
        center: ["40%", "60%"],
        itemStyle: {color: "rgba(250, 250, 250, 0.3)",},
        data: [{value: 10, name: ""}]
    }, {
        name: "透明圆圈",
        type: "pie",
